...
export class PerformanceIndexes1768088753181 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_5c06dc4ef5dde0151c0fbeaf0a" ON "employee_wallets" ("tenant_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_b3cf4b94987d3b77e9242af37e" ON "profiles" ("tenant_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_414e162a13c062cababc0550a1" ON "profiles" ("tenant_id", "team") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bb3a22ba6c6985c30ca3edc47b" ON "profiles" ("tenant_id", "department") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_d57e22e16d8b0c32f51af9de8b" ON "task_types" ("tenant_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_f4db2b9ac32351c52741cbdd2f" ON "package_items" ("tenant_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_d013f113228dc39673239ba2a9" ON "service_packages" ("tenant_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_64c382ca195306f588c79055c7" ON "clients" ("tenant_id", "email") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_545e976a52406b41671c3c11b1" ON "invoices" ("tenant_id", "client_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_344c231fafffe51efbd3f17e6d" ON "invoices" ("tenant_id", "due_date") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c7c70191c624dc41d7cbafdc10" ON "invoices" ("tenant_id", "status") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_0c41823fa6a879a6aeba177465" ON "bookings" ("tenant_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_23096dca2f7a9d1505d0267d4c" ON "bookings" ("client_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_402873fd6596d556781ac5d8ae" ON "bookings" ("package_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_40ea7a6141b2fde9058ff2837c" ON "bookings" ("tenant_id", "created_at") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_60aa850785e570c2181cd4d25e" ON "tasks" ("booking_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ea76a982cfc3dd4bff34daaf03" ON "tasks" ("task_type_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_327d5ce9cd59770b274f8c3579" ON "tasks" ("assigned_user_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_abb18e7a1300f18a66253a00e8" ON "tasks" ("tenant_id", "deleted_at") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_a9c93bbc847b97e2d84d5aebfa" ON "transaction_categories" ("tenant_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."transactions_type_enum" AS ENUM('INCOME', 'EXPENSE', 'PAYROLL')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_3906d00f6a4cd10bd8acef9ca0" ON "transactions" ("department") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_f1727abfbb0b1dfd42c357b8c3" ON "transactions" ("transaction_date") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."payouts_currency_enum" AS ENUM('USD', 'EUR', 'GBP', 'AED', 'SAR')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_7cfe3fe293be3c1ea331ad52e2" ON "recurring_transactions" ("tenant_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_2982dc30aa931f4db2ff53c648" ON "email_templates" ("tenant_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_949e8b074f10fe283dc754bfb8" ON "consents" ("tenant_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_f26200736ecd618cff7dc32365" ON "consents" ("tenant_id", "type") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_10fd6e488c564af9d71cc3376b" ON "consents" ("tenant_id", "user_id", "type") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_a8c683641d0c849c9ba682709e" ON "consents" ("tenant_id", "id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_794b624ef3b3b9b07bf3cb3d65" ON "time_entries" ("tenant_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_973ceb9e119e69f5b42fbfa44a" ON "email_verification_tokens" ("email") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_2ecfa961f2f3e33fff8e19b6c7" ON "password_reset_tokens" ("email") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_f6ac03431c311ccb8bbd7d3af1" ON "subscriptions" ("tenant_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_997f872384513653afac31a9c4" ON "department_budgets" ("tenant_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_374a79c5eaafd0c0bfe57012aa" ON "department_budgets" ("period") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_c2f7fba0ddece3c4eabbaceb2e" ON "attendance" ("tenant_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_effb98e9f2cc1879e1f088fda8" ON "attendance" ("tenant_id", "date") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_5bf8dceabcabc6408ae195c241" ON "privacy_requests" ("tenant_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_cfc6d9c4706bd021093dfd9e45" ON "task_templates" ("tenant_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_94981adc298f36baa4d191b19d" ON "task_templates" ("tenant_id", "name") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_4d6fcde4ac5ca1d5823f51aa18" ON "webhooks" ("tenant_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "subscriptions" DROP COLUMN "current_period_start"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "subscriptions" DROP COLUMN "metadata"`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD "stripe_subscription_id" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD "stripe_customer_id" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD "stripe_price_id" character varying NOT NULL`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."subscriptions_billing_interval_enum" AS ENUM('MONTH', 'YEAR')`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD "current_period_start" TIMESTAMP WITH TIME ZONE NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD "current_period_end" TIMESTAMP WITH TIME ZONE NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD "cancel_at_period_end" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD "canceled_at" TIMESTAMP WITH TIME ZONE`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD "trial_start" TIMESTAMP WITH TIME ZONE`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD "trial_end" TIMESTAMP WITH TIME ZONE`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD "quantity" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(`ALTER TABLE "subscriptions" ADD "metadata" jsonb`);
    await queryRunner.query(
      `CREATE TYPE "public"."subscriptions_plan_enum" AS ENUM('FREE', 'PRO', 'ENTERPRISE')`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD "plan" "public"."subscriptions_plan_enum" NOT NULL DEFAULT 'FREE'`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD "start_date" TIMESTAMP WITH TIME ZONE NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD "end_date" TIMESTAMP WITH TIME ZONE`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD "auto_renew" boolean NOT NULL DEFAULT true`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_af049b5733533a8c0dc0704cb9"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "webhook_deliveries" DROP CONSTRAINT "FK_a0286aeb96db651efd1ae2966f2"`,
    );
    await queryRunner.query(
      `ALTER TABLE "privacy_requests" DROP CONSTRAINT "FK_36472f11819bc596b23ee32d30c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "privacy_requests" DROP CONSTRAINT "FK_bf80739715888ad5bbf43f67f3d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "performance_reviews" DROP CONSTRAINT "FK_2d11995817c8d382fb313dc46cf"`,
    );
    await queryRunner.query(
      `ALTER TABLE "performance_reviews" DROP CONSTRAINT "FK_7f24e8687a99cdf941196fa5413"`,
    );
    await queryRunner.query(
      `ALTER TABLE "attendance" DROP CONSTRAINT "FK_114fd37af44814b27ab7d74c835"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "billing_customers" DROP CONSTRAINT "FK_2abf97465a7ce3cf6e18a8508ed"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tenants" DROP CONSTRAINT "FK_aed86c3f19e3b790a9e3bd4e234"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "consents" DROP CONSTRAINT "FK_946390b9024aba22cd1c1621430"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "attachments" DROP CONSTRAINT "FK_6883cc6070ab24d6a72dad5e7b0"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "transaction_categories" DROP CONSTRAINT "FK_d888946e8e569268b98ce4ca29e"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tasks" DROP CONSTRAINT "FK_327d5ce9cd59770b274f8c3579f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tasks" DROP CONSTRAINT "FK_ea76a982cfc3dd4bff34daaf036"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tasks" DROP CONSTRAINT "FK_60aa850785e570c2181cd4d25e0"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "invoices" DROP CONSTRAINT "FK_ed9c7aa7846704bbcb648377e8f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "package_items" DROP CONSTRAINT "FK_cd8a81bf2e0947c4bf53f9aac25"`,
    );
    await queryRunner.query(
      `ALTER TABLE "package_items" DROP CONSTRAINT "FK_4af1566b499be54342efb0b96c1"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."subscriptions_billing_interval_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" DROP COLUMN "stripe_price_id"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b41a9153894afa48ae2cccd8de"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_80be90bd4cdf5954850d4888ee"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2e91cd05675ec021a1c75f621f"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4d6fcde4ac5ca1d5823f51aa18"`,
    );
    await queryRunner.query(`DROP TABLE "webhooks"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_033f24e796eb3a4f14cac6c8dd"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_94981adc298f36baa4d191b19d"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_cfc6d9c4706bd021093dfd9e45"`,
    );
    await queryRunner.query(`DROP TABLE "task_templates"`);
    await queryRunner.query(
      `DROP TYPE "public"."task_templates_default_status_enum"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_44a9acfce795c82ce1beaf88bc"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ef6c5f2ace1b1a1a0de5537365"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_28c2ef9c76ab901d1c58637c7e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1dfd1dcf92ac8624fcdf6e0bfb"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5bf8dceabcabc6408ae195c241"`,
    );
    await queryRunner.query(`DROP TABLE "privacy_requests"`);
    await queryRunner.query(
      `DROP TYPE "public"."privacy_requests_status_enum"`,
    );
    await queryRunner.query(`DROP TYPE "public"."privacy_requests_type_enum"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a291fc8b253e3cb79eee1b70ba"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_751ed23a6327ca955adc0426ee"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_87baa58d173e0aafdc71340282"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7f6176b1ae7f1478d109219458"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."performance_reviews_period_type_enum"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_190318399b1c34afe329de7b11"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e1ceb697cdea2c117d6818fcea"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_effb98e9f2cc1879e1f088fda8"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c2f7fba0ddece3c4eabbaceb2e"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_472772835d7d3d90af3bbb413f"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_374a79c5eaafd0c0bfe57012aa"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_997f872384513653afac31a9c4"`,
    );
    await queryRunner.query(`DROP TABLE "department_budgets"`);
    await queryRunner.query(`DROP TABLE "user_preferences"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8344625d2464d332185030902f"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_af049b5733533a8c0dc0704cb9"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8236710a5135642b2311310209"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d3ec81cabc3c03a9f92b7a37f7"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b69921d81fb005fbcfdd7967ca"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_93ab8d9d6d5ac5798f4b7d01a1"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_76262f9e80f47de12c3dfa9a89"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1a468af552a0c98d521a271722"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_794b624ef3b3b9b07bf3cb3d65"`,
    );
    await queryRunner.query(`DROP TABLE "time_entries"`);
    await queryRunner.query(`DROP TYPE "public"."time_entries_status_enum"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a8c683641d0c849c9ba682709e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_10fd6e488c564af9d71cc3376b"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f26200736ecd618cff7dc32365"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_949e8b074f10fe283dc754bfb8"`,
    );
    await queryRunner.query(`DROP TABLE "consents"`);
    await queryRunner.query(`DROP TYPE "public"."consents_type_enum"`);
    await queryRunner.query(`DROP TABLE "notification_preferences"`);
    await queryRunner.query(
      `DROP TYPE "public"."notification_preferences_frequency_enum"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_15e34a853fee57b67fb3ac4d52"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2982dc30aa931f4db2ff53c648"`,
    );
    await queryRunner.query(`DROP TABLE "email_templates"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7b96dc34990c9c3462f604ec89"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b432cb72bfeb547a809e75fbd6"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9a6f00c87b582e7bbfd6e6f2ed"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e6ed024c6f398afadfb9cbff82"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7cfe3fe293be3c1ea331ad52e2"`,
    );
    await queryRunner.query(`DROP TABLE "recurring_transactions"`);
    await queryRunner.query(
      `DROP TYPE "public"."recurring_transactions_status_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."recurring_transactions_frequency_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."recurring_transactions_currency_enum"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e34fe53feb631ff94ab316a707"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f1727abfbb0b1dfd42c357b8c3"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3906d00f6a4cd10bd8acef9ca0"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_01e19ef89d1023edf0353d89d2"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_27840c32ef0173a3dc3a537a89"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a9c93bbc847b97e2d84d5aebfa"`,
    );
    await queryRunner.query(`DROP TABLE "transaction_categories"`);
    await queryRunner.query(
      `DROP TYPE "public"."transaction_categories_applicabletype_enum"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1e82eb99ade0bbd12cba554ed4"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_abb18e7a1300f18a66253a00e8"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_20d090a7b83189b4cddb3e3d0e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b03c99063a4eaf084f069a4d5a"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_327d5ce9cd59770b274f8c3579"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ea76a982cfc3dd4bff34daaf03"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_60aa850785e570c2181cd4d25e"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_716b6b4e89bad3466d007b81d7"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b678e8df5cba244396c89d6b64"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_40ea7a6141b2fde9058ff2837c"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_402873fd6596d556781ac5d8ae"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_23096dca2f7a9d1505d0267d4c"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0c41823fa6a879a6aeba177465"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2d3ced63b2eb8ae2407b1d3493"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ca69be6052c5b4fb34e19a4437"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c7c70191c624dc41d7cbafdc10"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_344c231fafffe51efbd3f17e6d"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_545e976a52406b41671c3c11b1"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_64c382ca195306f588c79055c7"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b8cb5e0d968c9498a3295183f3"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_84e812b6defb372516be517413"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d013f113228dc39673239ba2a9"`,
    );
    await queryRunner.query(`DROP TABLE "service_packages"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f4db2b9ac32351c52741cbdd2f"`,
    );
    await queryRunner.query(`DROP TABLE "package_items"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d57e22e16d8b0c32f51af9de8b"`,
    );
    await queryRunner.query(`DROP TABLE "task_types"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_bb3a22ba6c6985c30ca3edc47b"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_414e162a13c062cababc0550a1"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b3cf4b94987d3b77e9242af37e"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5c06dc4ef5dde0151c0fbeaf0a"`,
    );
