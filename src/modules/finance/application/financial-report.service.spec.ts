...
import type { CreateBudgetDto } from '../api/dto/budget.dto';
import type { DepartmentBudget } from '../domain/entities/department-budget.entity';
import type { PurchaseInvoice } from '../domain/entities/purchase-invoice.entity';
