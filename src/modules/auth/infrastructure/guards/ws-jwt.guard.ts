...
export class WsJwtGuard implements CanActivate {
  ...
  private extractTokenFromHandshake(client: Socket): string | undefined {
    ...
    // Query tokens never allowed in production — they leak JWTs to proxy/access logs.
    ...
    if (isProd && this.configService.get<string>('WS_ALLOW_QUERY_TOKEN') === 'true') {
      this.logger.warn('WS_ALLOW_QUERY_TOKEN=true is set but ignored in production. Remove this env var.');
    }
