...
describe('AuthController', () => {
    ...
    const mockUser = { id: 'uuid', email: 'admin@example.com', role: Role.ADMIN, isActive: true } as User;
    ...
    describe('register', () => {
        it('should call authService.register', async () => {
            ...
            expect(authService.register).toHaveBeenCalledWith(dto, { userAgent: 'test-agent', ipAddress: mockIp });
    ...
    describe('login', () => {
        it('should call authService.login', async () => {
            ...
            expect(authService.login).toHaveBeenCalledWith(dto, { userAgent: 'test-agent', ipAddress: mockIp });
            expect(result).toEqual(mockAuthResponse);
        });
    });
    ...
    describe('refreshTokens', () => {
        it('should call authService.refreshTokens', async () => {
            ...
            expect(authService.refreshTokens).toHaveBeenCalledWith('old-refresh', { userAgent: 'test-agent', ipAddress: mockIp });
            expect(result).toEqual(mockAuthResponse);
        });
    });
    ...
    describe('getSessions', () => {
        it('should return active sessions', async () => {
            const mockSessions = [{ id: 's1', userAgent: 'test', ipAddress: '127.0.0.1', createdAt: new Date(), lastUsedAt: new Date() }];
