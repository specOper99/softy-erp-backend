...
import type { Payout } from '../../finance/domain/entities/payout.entity';
import { PayoutStatus } from '../../finance/domain/enums/payout-status.enum';
import { PayoutRepository } from '../../finance/infrastructure/payout.repository';
import { TicketingService } from '../../notifications/application/ticketing.service';
import { TenantsService } from '../../tenants/application/tenants.service';
import { PAYMENT_GATEWAY, type PaymentGateway } from './payment-gateway.service';
...
describe('PayrollReconciliationService', () => {
  ...
  let _paymentGatewayService: jest.Mocked<PaymentGateway>;
  ...
  beforeEach(async () => {
    ...
    _paymentGatewayService = module.get(PAYMENT_GATEWAY);
