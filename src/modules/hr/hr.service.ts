...
import { CreateProfileDto, PayrollRunResponseDto, UpdateProfileDto } from './dto';
...
export class HrService {
    ...
    async createProfile(dto: CreateProfileDto): Promise<Profile> {
        ...
        await this.auditService.log({
            ...
            newValues: { userId: dto.userId, firstName: dto.firstName, lastName: dto.lastName, baseSalary: dto.baseSalary },
        });
    ...
    async updateProfile(id: string, dto: UpdateProfileDto): Promise<Profile> {
        ...
        if (dto.baseSalary !== undefined || dto.firstName || dto.lastName || dto.jobTitle) {
            await this.auditService.log({
                action: 'UPDATE',
                entityName: 'Profile',
                entityId: id,
    ...
    async deleteProfile(id: string): Promise<void> {
        ...
        await this.auditService.log({
            ...
            entityName: 'Profile',
            entityId: id,
            oldValues: { userId: profile.userId, firstName: profile.firstName, lastName: profile.lastName },
        });
    }
    ...
    async runPayroll(): Promise<PayrollRunResponseDto> {
        ...
        try {
            ...
            for (const profile of profiles) {
                ...
                const transaction = await this.financeService.createTransactionWithManager(
                    queryRunner.manager,
                    {
                ...
                if (profile.user?.email) {
                    this.mailService.sendPayrollNotification({
