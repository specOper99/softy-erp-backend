...
describe('TasksController', () => {
  ...
  let assigneeService: TaskAssigneeService;
  ...
  beforeEach(async () => {
    ...
    assigneeService = module.get<TaskAssigneeService>(TaskAssigneeService);
  });
  ...
  describe('assign', () => {
    it('should call service.assignTask', async () => {
      ...
      expect(assigneeService.assignTask).toHaveBeenCalledWith('uuid', dto);
    });
  });
  ...
  describe('addAssignee', () => {
    it('should call service.addTaskAssignee', async () => {
      ...
      expect(assigneeService.addTaskAssignee).toHaveBeenCalledWith('uuid', dto);
    });
  });
  ...
  describe('listAssignees', () => {
    it('should call service.listTaskAssignees', async () => {
      ...
      expect(assigneeService.listTaskAssignees).toHaveBeenCalledWith('uuid', mockUser);
    });
  });
  ...
  describe('updateAssignee', () => {
    it('should call service.updateTaskAssignee', async () => {
      ...
      expect(assigneeService.updateTaskAssignee).toHaveBeenCalledWith('uuid', 'u-uuid', dto);
    });
  });
  ...
  describe('removeAssignee', () => {
    it('should call service.removeTaskAssignee', async () => {
      ...
      expect(assigneeService.removeTaskAssignee).toHaveBeenCalledWith('uuid', 'u-uuid');
    });
  });
