...
export class MailService {
  ...
  async sendBookingConfirmation(data: BookingEmailData): Promise<void> {
    ...
    try {
      ...
      this.logger.error(
        `Failed to send booking confirmation to ${data.clientEmail}`,
        error,
      );
    }
  }
  ...
  async sendTaskAssignment(data: TaskAssignmentEmailData): Promise<void> {
    ...
    try {
      ...
      this.logger.error(
        `Failed to send task assignment to ${data.employeeEmail}`,
        error,
      );
    }
  }
  ...
  async sendPayrollNotification(data: PayrollEmailData): Promise<void> {
    ...
    try {
      ...
      this.logger.error(
        `Failed to send payroll notification to ${data.employeeEmail}`,
        error,
      );
    }
  }
