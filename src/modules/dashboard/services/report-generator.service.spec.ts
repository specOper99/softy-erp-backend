  ...
  describe('generateDashboardPdf', () => {
    it('should generate a PDF buffer', async () => {
      const mockData = {
        ...
        revenue: { totalRevenue: 1000, totalExpenses: 500, totalPayroll: 200, netProfit: 300, revenueByMonth: [] },
        bookingTrends: [],
        staffPerformance: [],
        packageStats: [],
      };
    ...
    it('should handle empty data gracefully', async () => {
      const mockData = {
        ...
        revenue: { totalRevenue: 0, totalExpenses: 0, totalPayroll: 0, netProfit: 0, revenueByMonth: [] },
        bookingTrends: [],
        staffPerformance: [],
        packageStats: [],
      };
