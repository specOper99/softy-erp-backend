...
describe('DashboardService', () => {
    ...
    describe('getRevenueSummary', () => {
        it('should return revenue summary stats', async () => {
            ...
            jest.spyOn(transactionRepository, 'createQueryBuilder').mockReturnValue(createQueryBuilder);
    ...
    describe('getPackageStats', () => {
        it('should return package stats', async () => {
            ...
            jest.spyOn(bookingRepository, 'createQueryBuilder').mockReturnValue(createQueryBuilder);
