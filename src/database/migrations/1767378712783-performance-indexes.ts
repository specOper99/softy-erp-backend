...
export class PerformanceIndexes1767378712783 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_audit_logs_tenant"`);
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_e9f4c2efab52114c4e99e28efb"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_user_composite_tenant"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_365b158cbdb7b7bc18bca4004a"`);
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_f07854cfd9da774d04ba5dfbf7" ON "payouts" ("tenant_id") `);
    await queryRunner.query(
      `CREATE UNIQUE INDEX IF NOT EXISTS "IDX_4a37d57cd4b1df2e4c3f3c3981" ON "payouts" ("tenant_id", "id") `,
    );
    await queryRunner.query(`ALTER TABLE "bookings" DROP COLUMN IF EXISTS "client_name"`);
    await queryRunner.query(`ALTER TABLE "bookings" DROP COLUMN IF EXISTS "client_phone"`);
    await queryRunner.query(`ALTER TABLE "bookings" DROP COLUMN IF EXISTS "client_email"`);
    await queryRunner.query(`ALTER TABLE "transactions" DROP COLUMN IF EXISTS "reference_id"`);
    await queryRunner.query(`ALTER TABLE "transactions" DROP COLUMN IF EXISTS "reference_type"`);
    await queryRunner.query(`DROP TYPE "public"."transactions_reference_type_enum"`);
    await queryRunner.query(`ALTER TABLE "bookings" ADD COLUMN IF NOT EXISTS "client_id" uuid`);
    await queryRunner.query(`ALTER TABLE "transactions" ADD COLUMN IF NOT EXISTS "booking_id" uuid`);
    await queryRunner.query(`ALTER TABLE "transactions" ADD COLUMN IF NOT EXISTS "task_id" uuid`);
    await queryRunner.query(`ALTER TABLE "transactions" ADD COLUMN IF NOT EXISTS "payout_id" uuid`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "employee_wallets" DROP CONSTRAINT "FK_a5561fb92e47e5b1423c9a7878e"`);
    await queryRunner.query(`ALTER TABLE "transactions" DROP CONSTRAINT "CHK_3c04c8c3a9eb587dc4119d404b"`);
    ...
    await queryRunner.query(`ALTER TABLE "employee_wallets" DROP CONSTRAINT "UQ_a5561fb92e47e5b1423c9a7878e"`);
    await queryRunner.query(
      `ALTER TABLE "employee_wallets" ADD CONSTRAINT "FK_a5561fb92e47e5b1423c9a7878e" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(`ALTER TABLE "bookings" ADD "client_name" character varying NOT NULL`);
    ...
    await queryRunner.query(`CREATE INDEX "IDX_attachments_tenant" ON "attachments" ("tenant_id") `);
    await queryRunner.query(`CREATE INDEX "IDX_365b158cbdb7b7bc18bca4004a" ON "transactions" ("reference_id") `);
    await queryRunner.query(`CREATE UNIQUE INDEX "IDX_user_composite_tenant" ON "users" ("id", "tenant_id") `);
    await queryRunner.query(`CREATE UNIQUE INDEX "IDX_e9f4c2efab52114c4e99e28efb" ON "users" ("email", "tenant_id") `);
    await queryRunner.query(`CREATE UNIQUE INDEX "IDX_task_composite_tenant" ON "tasks" ("id", "tenant_id") `);
    await queryRunner.query(`CREATE UNIQUE INDEX "IDX_booking_composite_tenant" ON "bookings" ("id", "tenant_id") `);
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_package_composite_tenant" ON "service_packages" ("id", "tenant_id") `,
    );
    await queryRunner.query(`CREATE UNIQUE INDEX "IDX_tasktype_composite_tenant" ON "task_types" ("id", "tenant_id") `);
    await queryRunner.query(`CREATE INDEX "IDX_profiles_tenant" ON "profiles" ("tenant_id") `);
    await queryRunner.query(
