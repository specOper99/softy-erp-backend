...
export class AddPerformanceIndexes1767084233890 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "employee_wallets" DROP CONSTRAINT "FK_employee_wallets_user"`,
    );
    await queryRunner.query(
      `ALTER TABLE "profiles" DROP CONSTRAINT "FK_profiles_user"`,
    );
    await queryRunner.query(
      `ALTER TABLE "package_items" DROP CONSTRAINT "FK_package_items_package"`,
    );
    await queryRunner.query(
      `ALTER TABLE "package_items" DROP CONSTRAINT "FK_package_items_task_type"`,
    );
    await queryRunner.query(
      `ALTER TABLE "bookings" DROP CONSTRAINT "FK_bookings_package"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tasks" DROP CONSTRAINT "FK_tasks_booking"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tasks" DROP CONSTRAINT "FK_tasks_task_type"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "attachments" DROP CONSTRAINT "FK_attachments_booking"`,
    );
    await queryRunner.query(
      `ALTER TABLE "attachments" DROP CONSTRAINT "FK_attachments_task"`,
    );
    await queryRunner.query(`DROP INDEX "public"."idx_audit_logs_entity_date"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_employee_wallets_tenant"`,
    );
    await queryRunner.query(`DROP INDEX "public"."IDX_task_types_tenant"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_package_items_tenant"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_service_packages_tenant"`,
    );
    await queryRunner.query(`DROP INDEX "public"."IDX_bookings_tenant"`);
    await queryRunner.query(`DROP INDEX "public"."idx_bookings_tenant_status"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_tasks_tenant"`);
    await queryRunner.query(`DROP INDEX "public"."idx_tasks_booking"`);
    await queryRunner.query(`DROP INDEX "public"."idx_tasks_assigned_user"`);
    ...
    await queryRunner.query(
      `DROP INDEX "public"."idx_transactions_tenant_date"`,
    );
    await queryRunner.query(`DROP INDEX "public"."idx_transactions_reference"`);
    await queryRunner.query(`DROP INDEX "public"."idx_attachments_booking"`);
    await queryRunner.query(`DROP INDEX "public"."idx_attachments_task"`);
    await queryRunner.query(
      `ALTER TABLE "employee_wallets" DROP COLUMN "tenant_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "employee_wallets" ADD "tenant_id" character varying NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "task_types" DROP COLUMN "tenant_id"`);
    await queryRunner.query(
      `ALTER TABLE "task_types" ADD "tenant_id" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "package_items" DROP COLUMN "tenant_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "package_items" ADD "tenant_id" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_packages" DROP COLUMN "tenant_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_packages" ADD "tenant_id" character varying NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "bookings" DROP COLUMN "tenant_id"`);
    await queryRunner.query(
      `ALTER TABLE "bookings" ADD "tenant_id" character varying NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tasks" ADD "tenant_id" character varying NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "tenant_id" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP COLUMN "tenant_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD "tenant_id" character varying NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD "tenant_id" uuid NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "tenant_id"`);
    await queryRunner.query(`ALTER TABLE "users" ADD "tenant_id" uuid`);
    await queryRunner.query(
      `CREATE TYPE "public"."tasks_status_enum_old" AS ENUM('PENDING', 'ASSIGNED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED')`,
    );
    await queryRunner.query(
      `ALTER TABLE "tasks" ALTER COLUMN "status" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(`ALTER TABLE "tasks" DROP COLUMN "tenant_id"`);
    await queryRunner.query(
      `ALTER TABLE "tasks" ADD "tenant_id" uuid NOT NULL`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."bookings_status_enum_old" AS ENUM('DRAFT', 'CONFIRMED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED')`,
    );
    await queryRunner.query(
      `ALTER TABLE "bookings" ALTER COLUMN "status" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(`ALTER TABLE "bookings" DROP COLUMN "tenant_id"`);
    await queryRunner.query(
      `ALTER TABLE "bookings" ADD "tenant_id" uuid NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_packages" DROP COLUMN "tenant_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "service_packages" ADD "tenant_id" uuid NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "package_items" DROP COLUMN "tenant_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "package_items" ADD "tenant_id" uuid NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "task_types" DROP COLUMN "tenant_id"`);
    await queryRunner.query(
      `ALTER TABLE "task_types" ADD "tenant_id" uuid NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "employee_wallets" DROP COLUMN "tenant_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "employee_wallets" ADD "tenant_id" uuid NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "attachments" ADD CONSTRAINT "FK_attachments_task" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "attachments" ADD CONSTRAINT "FK_attachments_booking" FOREIGN KEY ("booking_id") REFERENCES "bookings"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tasks" ADD CONSTRAINT "FK_tasks_user" FOREIGN KEY ("assigned_user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tasks" ADD CONSTRAINT "FK_tasks_task_type" FOREIGN KEY ("task_type_id") REFERENCES "task_types"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tasks" ADD CONSTRAINT "FK_tasks_booking" FOREIGN KEY ("booking_id") REFERENCES "bookings"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "bookings" ADD CONSTRAINT "FK_bookings_package" FOREIGN KEY ("package_id") REFERENCES "service_packages"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "package_items" ADD CONSTRAINT "FK_package_items_task_type" FOREIGN KEY ("task_type_id") REFERENCES "task_types"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "package_items" ADD CONSTRAINT "FK_package_items_package" FOREIGN KEY ("package_id") REFERENCES "service_packages"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "profiles" ADD CONSTRAINT "FK_profiles_user" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "employee_wallets" ADD CONSTRAINT "FK_employee_wallets_user" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
}
