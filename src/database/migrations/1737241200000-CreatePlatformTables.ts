...
export class CreatePlatformTables1737241200000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      -- NOTE: Tenant entity uses column name "subscriptionPlan" (camelCase)
      -- so the index must reference the correct column.
      CREATE INDEX IF NOT EXISTS idx_tenants_subscription ON tenants("subscriptionPlan", status);
