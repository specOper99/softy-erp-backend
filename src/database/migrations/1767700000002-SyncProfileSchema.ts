...
export class SyncProfileSchema1767700000002 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "profiles" ADD COLUMN IF NOT EXISTS "address" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "profiles" ADD COLUMN IF NOT EXISTS "city" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "profiles" ADD COLUMN IF NOT EXISTS "country" character varying`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "profiles" ADD COLUMN IF NOT EXISTS "team" character varying`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD COLUMN IF NOT EXISTS "department" character varying`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP COLUMN IF EXISTS "department"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE IF EXISTS "profiles_contract_type_enum"`,
    );
    await queryRunner.query(
