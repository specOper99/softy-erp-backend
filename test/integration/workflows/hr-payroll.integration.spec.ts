...
import { DashboardGateway } from '../../../src/modules/dashboard/api/dashboard.gateway';
import { DepartmentBudget } from '../../../src/modules/finance/domain/entities/department-budget.entity';
import { EmployeeWallet } from '../../../src/modules/finance/domain/entities/employee-wallet.entity';
import { Payout } from '../../../src/modules/finance/domain/entities/payout.entity';
import { Transaction } from '../../../src/modules/finance/domain/entities/transaction.entity';
import { PayoutStatus } from '../../../src/modules/finance/domain/enums/payout-status.enum';
import { CurrencyService } from '../../../src/modules/finance/application/currency.service';
import { FinanceService } from '../../../src/modules/finance/application/finance.service';
import { WalletService } from '../../../src/modules/finance/application/wallet.service';
import { PayrollRun } from '../../../src/modules/hr/domain/entities/payroll-run.entity';
import { Profile } from '../../../src/modules/hr/domain/entities/profile.entity';
import { HrService } from '../../../src/modules/hr/application/hr.service';
import { ProfileRepository } from '../../../src/modules/hr/infrastructure/profile.repository';
import { PayrollRunRepository } from '../../../src/modules/hr/infrastructure/payroll-run.repository';
import { PayrollService } from '../../../src/modules/hr/application/payroll.service';
import { MockPaymentGatewayService } from '../../../src/modules/hr/application/payment-gateway.service';
